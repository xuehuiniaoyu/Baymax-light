...

        {
            ...
            put("int[]", new Convert() {
                ...
                public Object convert(String value) {
                    ...
                    for (int i = 0; i < arrays.length; i++) {
                        results[i] = Integer.parseInt(arrays[i].trim());
                    }
                    return results;
                }
            });
            ...
            put("double[]", new Convert() {
                ...
                public Object convert(String value) {
                    ...
                    for (int i = 0; i < arrays.length; i++) {
                        results[i] = Double.parseDouble(arrays[i].trim());
                    }
                    return results;
                }
            });
            ...
            put("short[]", new Convert() {
                ...
                public Object convert(String value) {
                    ...
                    for (int i = 0; i < arrays.length; i++) {
                        results[i] = Short.parseShort(arrays[i].trim());
                    }
                    return results;
                }
            });
            ...
            put("float[]", new Convert() {
                ...
                public Object convert(String value) {
                    ...
                    for (int i = 0; i < arrays.length; i++) {
                        results[i] = Float.parseFloat(arrays[i].trim());
                    }
                    return results;
                }
            });
            ...
            put("boolean[]", new Convert() {
                ...
                public Object convert(String value) {
                    ...
                    for (int i = 0; i < arrays.length; i++) {
                        results[i] = Boolean.parseBoolean(arrays[i].trim());
                    }
                    return results;
                }
            });
            ...
            put("long[]", new Convert() {
                ...
                public Object convert(String value) {
                    ...
                    for (int i = 0; i < arrays.length; i++) {
                        results[i] = Long.parseLong(arrays[i].trim());
                    }
                    return results;
                }
            });
